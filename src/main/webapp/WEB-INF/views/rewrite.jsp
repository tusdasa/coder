	...
	<div class="container">
				...
				<div class="form-group">
					<div class="col-sm-12">
						<label for="name">分类:</label> <select class="form-control"
							...
							<c:if test="${ category.acid eq article.category.acid }">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<c:forEach items="${ tags }" var="tag">
									...
									<c:forEach items="${ article.tags }" var="atag">
										<c:if test="${ atag.tid eq tag.tid }">
										<div class="checkbox"><label><input type="checkbox" checked="checked" name="tag" value="${ tag.tid }" />${ tag.content }</label></div>
										</c:if>
									</c:forEach>
									<div class="checkbox"><label><input type="checkbox" name="tag" value="${ tag.tid }" />${ tag.content }</label></div>
								</c:forEach>
							</div>
		...
		<div class="row clearfix">
			...
			<div class="col-md-12 column" style="z-index:1;">
				<div>
					<div class="col-md-12 column" id="edit" style="height: 400px;">${ article.content }</div>
				</div>
			</div>
